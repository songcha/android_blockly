...
Blockly.JavaScript['cyh_test1'] = function (block) {
    var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);

    var code = 'cyh0123q@naver.cocmcjkjflk';
    return code;
};

Blockly.JavaScript['cyh_test_1'] = function (block) {
    var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', Blockly.JavaScript.ORDER_ATOMIC);

    var code = '첫번째 테스트 블록입니다.';
    return code;
};

Blockly.JavaScript['go_block'] = function(block) {
  var text_number = block.getFieldValue('number');
  return "앞으로 "+ text_number+"블록";
};
